    ...
    return (
        <div className='home'>
            ...
            <div className="flex justify-center">
                <div style={{textAlign: "center"}}className="w-2/5">
                    <div className='text-black mt-44 dark:text-white text-4xl logo-text'>GuluGulu</div>
                    <br /><br />
                    <form onSubmit={() => handleSearch()} class="mb-6">
                        <input onChange={(e) => setSearchItem(e.target.value)} type="text" id="large-input" placeholder='Search' class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    </form>
                </div>
            </div>
        </div>
