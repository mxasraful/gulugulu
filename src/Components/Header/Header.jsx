...
const Header = ({ darkMode, darkPreference }) => {
    ...
    return (
        <div className="">
            <div className='pb-1 pt-1 flex flex-wrap dark:bg-slate-700 sm:justify-between justify-center items-center border-b dark:border-gray-700 grid grid-cols-4 gap-4 place-items-center'>
                <div class="">
                    <Link to='/'>
                        ...
                        <div className='text-sm dark:text-white' style={{fontSize: '7px', marginTop: "-12px"}}>Powered By Google</div>
                    </Link>
                </div>
                <div class="flex col-span-2 w-full justify-center">
                    <div className=" hidden md:block  mt-2 mb-2 dark:bg-slate-400 relative rounded-md shadow-sm w-3/4">
                        <input
                            type="text"
                            name="Search"
                            id="headerSearchBox"
            ...
            <div class="flex md:hidden block  col-span-2 w-full justify-center">
